...
public class MfGeoJSONReaderTest extends TestCase {
	...
	public void testLineString() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"LineString\", \"coordinates\": [ [100.0, 0.0], [101.0, 1.0] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testPolygonNoHoles() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"Polygon\", \"coordinates\": [ [ [100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0] ] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testPolygonWithHoles() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"Polygon\", \"coordinates\": [ [ [100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0] ], [ [100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8], [100.2, 0.2] ] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
		assertSame(Polygon.class, jts.getClass());
	...
	public void testMultiPoint() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"MultiPoint\", \"coordinates\": [ [100.0, 0.0], [101.0, 1.0] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testMultiLineString() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"MultiLineString\", \"coordinates\": [ [ [100.0, 0.0], [101.0, 1.0] ], [ [102.0, 2.0], [103.0, 3.0] ] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testMultiPolygonNoHoles() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"MultiPolygon\", \"coordinates\": [ [[[102.0, 2.0], [103.0, 2.0], [103.0, 3.0], [102.0, 3.0], [102.0, 2.0]]], [[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0]], [[100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8], [100.2, 0.2]]] ] }");
		assertSame(MfGeometry.class, result.getClass());
		MfGeometry geom = (MfGeometry) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testGeometryCollection() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"GeometryCollection\", \"geometries\": [ { \"type\": \"Point\", \"coordinates\": [100.0, 0.0] }, { \"type\": \"LineString\", \"coordinates\": [ [101.0, 0.0], [102.0, 1.0] ] } ] }");
		assertSame(MfGeometryCollection.class, result.getClass());
		MfGeometryCollection geom = (MfGeometryCollection) result;
		Geometry jts = geom.getInternalGeometry();
	...
	public void testFeature() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [102.0, 0.5]}, \"properties\": {\"prop0\": \"value0\"} }");
	...
	public void testFeatureCollection() throws JSONException {
		MfGeo result = reader
				.decode("{ \"type\": \"FeatureCollection\", \"features\": [ { \"type\": \"Feature\", id: \"toto\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [102.0, 0.5]}, \"properties\": {\"prop0\": \"value0\"} }, { \"type\": \"Feature\", \"geometry\": { \"type\": \"LineString\", \"coordinates\": [ [102.0, 0.0], [103.0, 1.0], [104.0, 0.0], [105.0, 1.0] ] }, \"properties\": { \"prop0\": \"value0\", \"prop1\": 0.0 } } ] }");
